...
sub = args.subject
project_dir = '/your_data_path/'

fif_file = os.path.join(project_dir,f"ds004212-download/derivatives/preprocessed/preprocessed_P{sub}-epo.fif")

concept_csv_file_path = os.path.join(project_dir,'ds004212-download/image-concept-index.csv')
csv_img_file_path = os.path.join(project_dir,"ds004212-download/image-paths.csv")


origin_img_dir = os.path.join(project_dir,"object_images/")
...
save_dir = os.path.join(project_dir,f"things_meg/sub-{format(sub,'02')}")
...
print(image_concept_df) # 0~6106, 1854 
...
img_path_list_training = [path.split('your_data_path/Image_set/')[1] for path in img_path_list_training]
img_path_list_test = [path.split('your_data_path/Image_set/')[1] for path in img_path_list_test]


print(img_path_list_training)
