...
def load_data(config):
    ...
    if exp_setting == 'intra-subject':
        ...
        val_loader = DataLoader(val_dataset, batch_size=config['data']['val_batch_size'], shuffle=True, drop_last=False,num_workers=32)#, pin_memory=True)
...
class EEGDataset(Dataset):
    def __init__(self, config, mode):
        ...
        elif self.selected_ch == "OP": # previous works
        ...
        elif self.selected_ch == "OPT":  # Occipital + Parietal + Central
            self.selected_ch = ['P7', 'P5', 'P3', 'P1', 'Pz', 'P2', 'P4', 'P6', 'P8',
                                'PO7', 'PO3', 'POz', 'PO4', 'PO8', 'O1', 'Oz', 'O2',
        ...
        elif self.selected_ch == "OPCT":  # Occipital + Parietal + Central + Temporal
            self.selected_ch = ['P7', 'P5', 'P3', 'P1', 'Pz', 'P2', 'P4', 'P6', 'P8',
                                'PO7', 'PO3', 'POz', 'PO4', 'PO8', 'O1', 'Oz', 'O2',
                                'C5', 'C3', 'C1', 'Cz', 'C2', 'C4', 'C6',
                                'CP5', 'CP3', 'CP1', 'CPz', 'CP2', 'CP4', 'CP6',
